        ...
        messages=[
            {
                ...
                your IELTS writing score: (write an approximate IELTS Writing Task 2 grade for this essay.)
                your mistakes:

                .......

                Here is a perfect example for your topic:
                (write here a perfect essay example)

                display the answer nicely with design HTML and CSS code 
                kind of:
                <h1 class="score">An approximate IELTS Writing Task 2 grade for this essay is '5.5' &#127882</h1>
                <h2 class="mistakes-title">Your Mistakes &#128269;: </h2>
                <ul class="mistakes">
                    <li>1 ....</li>
                    <li>2 ...</li>
                    <li>3...</li>
                ...
                <p class="perfect-example">essay ..........</p>
        ...
        messages=[
            {
                ...
                continue writing more information as much as possible
                '''
            }
        ],
        model="gpt-3.5-turbo",
...
def dict_view(request):
    if request.method == 'POST':
        ...
        return render(request, 'aiapp/dictionary.html', {'result': result, 'word': word})
    return render(request, 'aiapp/home.html')
        ...
        messages=[
            {
                ...
                more ideas for writing an essay ..
                write it in HTML like this 
                <h4> ......</h4>
                '''
            }
        ],
